...
*  Nếu $m$ là hợp số, $x^n \equiv x^{n \bmod{\varphi(m)}} \pmod{m}$
...
Vì phép nhân ma trận có tính chất kết hợp nên ta dễ dàng áp dụng kĩ thuật lũy thừa nhị phân (thay số nguyên thành ma trận) để đạt được độ phức tạp $\mathcal{O}(\log(n))$.
