...
Như vậy ta có thể sắp xếp lại các cặp số tăng dần theo $x$. Sau đó sử dụng stack để loại bỏ đi những cặp số không tiềm năng, cuối cùng còn lại một dãy các cặp với $x$ tăng dần và $y$ giảm dần.
