...
- Segment Tree còn có [một cách cài đặt khác sử dụng ít bộ nhớ hơn](translate/codeforces/Efficient-and-easy-segment-trees) (tối đa $2*N$ phần tử), tuy nhiên theo cá nhân mình không dễ hiểu bằng cách cài đặt này.
