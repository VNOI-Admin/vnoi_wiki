...
3. Dễ code. Chính vì hai ưu điểm ở trên, IT đoạn thẳng rất tổng quát và không cần phải xét trường hợp phụ thuộc vào bài toán như bao lồi. Đa số các bài toán, phần [Update](#update) và [Query](#query) của IT đoạn thẳng gần như giống hệt nhau. Phần thân chương trình cũng rất ngắn gọn.
...
- [VOJ - VMPIZZA](http://vnoi.info/problems/show/VMPIZZA/)
...
## [VOJ - VOMARIO](http://vnoi.info/problems/show/VOMARIO/)
...
- [VOJ - JEWELNB](http://vnoi.info/problems/show/JEWELNB/)
