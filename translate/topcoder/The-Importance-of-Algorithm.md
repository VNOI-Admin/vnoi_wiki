...
Dù đời sống có rất nhiều ví dụ, tôi sẽ giới thiệu ở đây 2 bài toán thực tế có cùng trình độ với các bài ở TopCoder. Bài đầu là **[Maximum Flow Problem (Luồng Cực Đại)](https://en.wikipedia.org/wiki/Maximum_flow_problem)**, và bài sau có liên quan đến **[Dynamic Programming (Quy Hoạch Động)](https://en.wikipedia.org/wiki/Dynamic_programming)** - một kĩ thuật giải quyết được những vấn đề tưởng như không thể với tốc độ "điện giật".
